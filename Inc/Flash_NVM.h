...
// Bootloader
 #define FLASH_BANKB_START_PAGE		ADDR_FLASH_PAGE_0+ 0   // page 0
 #define FLASH_BANKB_PAGES			16
 // Applicatio
 #define FLASH_BANKA_START_PAGE		ADDR_FLASH_PAGE_0+(16*2048) //page 16
 #define FLASH_BANKA_PAGES			56
 // Application copy
 #define FLASH_BANKC_START_PAGE		ADDR_FLASH_PAGE_0+(72*2048) //page 72
