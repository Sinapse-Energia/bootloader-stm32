...
QuectelBG96::QuectelBG96() : Transceiver(){
	urc =		"\r\n+QSSLURC: \"recv\",1\r\n";
	recvfmt =	"AT+QSSLRECV=1,%d\r";
	phandler =	getRecvPayload2;
...
//		{ATGET,		"",	{"AT+QISWTMD=?\r"}, {NULL,	NULL, SetGeneric},	{1000, 0}, 	1,  },
	...
	int i = ATCommandFlow(TCPFlow, (DEV_HANDLER) handler, WDT_ENABLED, &hiwdg,  0);
...
int	QuectelBG96::ConnectTLS(const char *apn, const char *host, int port){
	...
	int mode  = 0; // Mandatory NON-Transp in TLS?
